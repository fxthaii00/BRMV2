...
-- Utilise la transparence définie dans le slider de la config au lieu de 0.85
    ...
    -- FIX: Applique la couleur de la hitbox en temps réel depuis la configuration
    if root.Color ~= config.TARGET_BOX_COLOR then
